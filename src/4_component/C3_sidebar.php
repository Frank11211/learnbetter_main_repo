...
echo '
    <ul class="sidebar-item">
        ...
        <li><a href="../1_front_end/learnbetter_C3_enroll_training_page.php"><i class="fa-solid fa-book">  </i> Training Enroll </a></li>
        <li><a href="../1_front_end/learnbetter_C3_download_doc_page.php"><i class="fa-solid fa-file-arrow-down"></i> Download Document </a></li>
        <li><a href="../1_front_end/learnbetter_C3_view_enrollment_page.php"><i class="fa-solid fa-clock-rotate-left"> </i> Enroll History </a></li>
