...
<head>
  ...
  <link rel="stylesheet" href="../../css/learnbetter_C_account_page_style.css">
</head>
 ...
 <section> 
  ...
  <div  class="num_dis_style_acc">
        ...
        <div class="account_wrapper">
            ...
            <img src=" data:image;base64, <?php echo base64_encode( dis_admin_acc_img($conn, $_SESSION['user_id'])); ?>" id="preview_image" style="height: 150px; width: 150px;" alt="image_placehold"><br>
            ...
            <form name="A1_update_acc" method="POST" enctype="multipart/form-data">
                <div class= "info_wrapper">
                    ...
                    <h2>Change Password </h2><br><br>
                        ...
                        <p>Current Password :       <input type="password" name="upd_acc_new_pass_A1" id="display_password" value="<?php echo $_SESSION['user_pass'] ?>"  placeholder="*Min 6 character"></p><br>
                        <p>Reconfirm Setup Password :  <input type="password" name="upd_acc_retype_pass_A1" id="display_conf_password" value="<?php echo $_SESSION['user_pass'] ?>" > </p><br>
                    </div>
               ...
               <script>
                ...
                <input type="hidden" name="user_access_level" value="<?php echo $_SESSION['user_level']; ?>">
                ...
                inputField.addEventListener('change', function (event) {
                    ...
                    previewImage.src = "data:image;base64, <?php echo base64_encode(dis_admin_acc_img($conn, $_SESSION['user_id'])); ?>";
                    }
                });
                </script>
            </form>
