...
<head>
  ...
  <link rel="stylesheet" href="../../css/learnbetter_B_approve_candit_style.css ">
</head>
          ...
          while ($row = $sql_result->fetch_assoc()) {
            ...
            echo '<td>
                    <button class="btn_style_2">
                      <a href="../1_front_end/learnbetter_B2_candi_list_page.php?candi_course_code='.$row['course_code'].'&candi_course_name='.$row['course_name'].'" style="color:white">Candidate List</a>
                    </button>
