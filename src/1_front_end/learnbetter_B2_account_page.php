...
<head>
  ...
  <link rel="stylesheet" href="../../css/learnbetter_B_account_page_style.css">
</head>
...
<body>
    ...
    <div class="sidebar-acc-wrapper">
        ...
        <h4> 
            <?php 
                ...
                }elseif($_SESSION['trainee_gen'] === "Female"){
  ...
  <div  class="num_dis_style_acc">
        ...
        <div class="account_wrapper">
            ...
            <img src=" data:image;base64, <?php echo base64_encode( dis_admin_acc_img($conn, $_SESSION['trainee_id'])); ?>" id="preview_image" style="height: 150px; width: 150px;" alt="image_placehold"><br>
            ...
            <form name="A1_update_acc" method="POST" enctype="multipart/form-data">
                <div class= "info_wrapper">
                    ...
                    <div class="info_pass_wrapper">
                        ...
                        <button type= "button" id="show_password_btn" class="btn_style_6">Show Password</button>
                        <p>Current Password :       <input type="password" name="upd_acc_new_pass_A1" id="display_password" value="<?php echo $_SESSION['trainee_pass'] ?>"  placeholder="*Min 6 character"></p><br>
                        <p>Reconfirm Setup Password :  <input type="password" name="upd_acc_retype_pass_A1" id="display_conf_password" value="<?php echo $_SESSION['trainee_pass'] ?>" > </p><br>
                    </div>
                ...
                <input type="hidden" name="user_access_level" value="<?php echo $_SESSION['trainee_level']; ?>">
                ...
                <script>
                    ...
                    inputField.addEventListener('change', function (event) {
                        ...
                        if (file) {
                            ...
                            // When the file is loaded, set it as the source of the preview image
                        ...
                        previewImage.src = "data:image;base64, <?php echo base64_encode(dis_admin_acc_img($conn, $_SESSION['trainee_id'])); ?>";
                        }
                    });
                    </script>
            </form>
